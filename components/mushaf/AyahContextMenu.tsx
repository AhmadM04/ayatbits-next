    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Menu - SEPIA THEME with Dark Mode */}
          <motion.div
            ref={menuRef}
            ...
            className="fixed left-4 right-4 bottom-6 top-20 z-50 max-w-md mx-auto overflow-y-auto"
          >
            <div className="bg-white dark:bg-[#111] border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-2xl min-h-min">
              {/* Header */}
              <div className="px-4 py-3 border-b border-gray-200 dark:border-white/10 flex items-center justify-between bg-gray-50 dark:bg-[#1a1a1a] sticky top-0 z-10">
                <div>
              ...
              <div className="p-2 space-y-1">
                ...
                <button
                  ...
                  className={`
                    ...
                    ${verse.puzzleId 
                      ? 'hover:bg-emerald-50 dark:hover:bg-emerald-500/10 text-[#4A3728] dark:text-white' 
                      : 'opacity-50 cursor-not-allowed text-[#8E7F71] dark:text-gray-500'
                    }
                  `}
                >
                  <div className={`p-2 rounded-lg ${verse.puzzleId ? 'bg-emerald-100 dark:bg-emerald-500/20 border border-[#059669]/20 dark:border-emerald-500/30' : 'bg-gray-100 dark:bg-white/5'}`}>
                    <Play className={`w-5 h-5 ${verse.puzzleId ? 'text-[#059669] dark:text-emerald-400' : 'text-[#8E7F71] dark:text-gray-500'}`} />
                  </div>
                  <div>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-500/10 transition-colors text-left"
                >
                  <div className={`p-2 rounded-lg ${isPlaying ? 'bg-blue-100 dark:bg-blue-500/20 border border-blue-200 dark:border-blue-500/30' : 'bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20'}`}>
                    {isLoadingAudio ? (
                      <div className="w-5 h-5 border-2 border-blue-600 dark:border-blue-400 border-t-transparent rounded-full animate-spin" />
                    ) : (
                      <Volume2 className={`w-5 h-5 text-blue-600 dark:text-blue-400 ${isPlaying ? 'animate-pulse' : ''}`} />
                    )}
                  </div>
                  <div>
                    <p className="font-medium text-[#4A3728] dark:text-white">{t('mushaf.playAudio')}</p>
                    <p className="text-xs text-[#8E7F71] dark:text-gray-400">Listen to recitation</p>
                  </div>
                </button>
                ...
                <button
                  ...
                  className={`
                    w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-colors text-left
                    ${verse.puzzleId 
                      ? 'hover:bg-red-50 dark:hover:bg-red-500/10 text-[#4A3728] dark:text-white' 
                      : 'opacity-50 cursor-not-allowed text-[#8E7F71] dark:text-gray-500'
                    }
                  `}
                >
                  <div className={`p-2 rounded-lg ${isLiked ? 'bg-red-100 dark:bg-red-500/20 border border-red-200 dark:border-red-500/30' : 'bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20'}`}>
                    <Heart className={`w-5 h-5 text-[#EF4444] dark:text-red-400 ${isLiked ? 'fill-current' : ''}`} />
                  </div>
                  <div>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-teal-50 dark:hover:bg-teal-500/10 transition-colors text-left"
                >
                  <div className={`p-2 rounded-lg ${showTranslation ? 'bg-teal-100 dark:bg-teal-500/20 border border-teal-200 dark:border-teal-500/30' : 'bg-teal-50 dark:bg-teal-500/10 border border-teal-100 dark:border-teal-500/20'}`}>
                  ...
                  <div>
                    <p className="font-medium text-[#4A3728] dark:text-white">
                      {t('mushaf.viewTranslation')}
                    </p>
                    <p className="text-xs text-[#8E7F71] dark:text-gray-400">View meaning</p>
                  </div>
                </button>
                ...
                >
                  <div className={`p-2 rounded-lg ${showTafsir ? 'bg-blue-100 dark:bg-blue-500/20 border border-blue-200 dark:border-blue-500/30' : 'bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20'}`}>
                    {isLoadingTafsir ? (
                      <div className="w-5 h-5 border-2 border-blue-600 dark:border-blue-400 border-t-transparent rounded-full animate-spin" />
                    ) : (
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#8E7F71] dark:text-gray-400">View explanation</p>
                  </div>
                </button>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-pink-50 dark:hover:bg-pink-500/10 transition-colors text-left"
                  data-tutorial="ai-tafsir-button"
                >
                  <div className={`p-2 rounded-lg ${showAiTafsir ? 'bg-pink-100 dark:bg-pink-500/20 border border-pink-200 dark:border-pink-500/30' : 'bg-pink-50 dark:bg-pink-500/10 border border-pink-100 dark:border-pink-500/20'}`}>
                    {isLoadingAiTafsir ? (
                ...
                <button
                  onClick={handleShare}
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-amber-50 dark:hover:bg-amber-500/10 transition-colors text-left"
                >
                  ...
                  <div>
                    <p className="font-medium text-[#4A3728] dark:text-white">Share</p>
                    <p className="text-xs text-[#8E7F71] dark:text-gray-400">Share this ayah</p>
                  </div>
                </button>
              </div>

              {/* Translation Display - SEPIA THEME with Dark Mode */}
              <AnimatePresence>
                {showTranslation && translation && (
                  ...
                  >
                    <div className="p-4 bg-teal-50 dark:bg-teal-500/10">
                      <p className="text-sm text-[#4A3728] dark:text-gray-200 leading-relaxed">
                        {translation}
                      </p>
                    </div>
                  </motion.div>
              ...
              {/* Tafsir Display - SEPIA THEME with Dark Mode */}
              <AnimatePresence>
                {showTafsir && tafsir && (
                  <motion.div
                    initial={{ height: 0, opacity: 0 }}
                    ...
                    className="border-t border-gray-200 dark:border-white/10 overflow-hidden"
                  >
                    <div className="p-4 bg-blue-50 dark:bg-blue-500/10 max-h-80 overflow-y-auto">
                      ...
                      <div 
                        className="text-sm text-[#4A3728] dark:text-gray-200 leading-relaxed prose prose-sm max-w-none
                          prose-p:my-2 prose-strong:text-[#4A3728] dark:prose-strong:text-gray-100 prose-strong:font-semibold
              ...
              {/* AI Tafsir Display - SEPIA THEME with Dark Mode */}
              <AnimatePresence>
                {showAiTafsir && (aiTafsir || aiError) && (
                  <motion.div
                    ...
                    className="border-t border-gray-200 dark:border-white/10 overflow-hidden"
                  >
                    <div className="p-4 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-500/10 dark:to-purple-500/10 max-h-80 overflow-y-auto">
                      <div className="flex items-center gap-2 mb-2">
                      ...
                      {aiError ? (
                        <div className="text-sm text-red-700 dark:text-red-300 bg-red-100 dark:bg-red-500/10 border border-red-300 dark:border-red-500/30 rounded-lg p-3">
                          {aiError}
                          {requiresPro && (
                            <a 
                              href="/pricing" 
                              className="block mt-2 text-pink-600 dark:text-pink-400 hover:text-pink-700 dark:hover:text-pink-300 font-medium"
                              onClick={onClose}
                            >
                              View Pro Plans →
                            </a>
                        ...
                        <>
                          ...
                          <div className="text-sm text-[#4A3728] dark:text-gray-200 leading-relaxed whitespace-pre-wrap">
                            {aiTafsir}
                          </div>
                        </>
                      )}
